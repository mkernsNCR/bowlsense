...
| Frontend regressions | Pass | `npm test`: 49 Node tests and 99 Vitest checks, including detailed physical-pin, rendered Today, public-layout, and service-worker cache-isolation scenarios |
